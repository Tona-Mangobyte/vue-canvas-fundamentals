...
import { SpriteSheetArtist, Sprite, SimpleSpriteSheetArtist } from "@/sprites";
import {
  CycleBehavior,
  PaceBehavior,
  RunBehavior,
...
export default class HomeView extends Vue {
  ...
  /*platformArtist = {
    self = this;
    draw: function (sprite: any, context: any) {
      var top;
  ...
  // platformArtist = new SpriteSheetArtist(null, null);

  // Sprite behaviors..................................................
  /*runBehavior = {
    lastAdvanceTime: 0,

    execute: function (sprite: Sprite,
                       now: number,
                       fps: number,
                       context: any,
  ...
  createCoinSprites() {
    var coin,
      artist,
      blueCoinArtist = new SpriteSheetArtist(
        this.spritesheet,
        this.blueCoinCells
      ),
      goldCoinArtist = new SpriteSheetArtist(
        this.spritesheet,
        this.goldCoinCells
      );
  ...
  createSapphireSprites() {
    var sapphire,
      sapphireArtist = new SpriteSheetArtist(
        this.spritesheet,
        this.sapphireCells
      );
  ...
  createPlatformSprites() {
    var sprite: any, pd: any; // Sprite, Platform data
